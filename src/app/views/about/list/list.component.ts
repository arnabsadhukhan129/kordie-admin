...
export class ListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.aboutPage = this._pageService.getCurrentPage().subscribe((page:any)=>{
      if(page){
        this.current = page
      }
      else{
  ...
  ngOnDestroy(): void {
      ...
      getList(page = this.current, limit = this.recordsPerPage) {
        ...
        this.__about.getList(params, this.searchType, this.searchVal)
            .subscribe((response)=>{
