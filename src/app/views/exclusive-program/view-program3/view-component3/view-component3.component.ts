...
@Component({
  selector: 'app-view-component3',
  templateUrl: './view-component3.component.html',
  styleUrls: ['./view-component3.component.scss']
})
export class ViewComponent3Component implements OnInit {
  isDisabled = true;
