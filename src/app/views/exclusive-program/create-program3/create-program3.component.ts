...
@Component({
  selector: 'app-create-program3',
  templateUrl: './create-program3.component.html',
  styleUrls: ['./create-program3.component.scss']
})
export class CreateProgram3Component implements OnInit {
  ...
  checkMessage() {
    ...
    getCategory(){
      ...
      getDetail() {
        this.__program3.getDetailById(this.detailsId).subscribe(
          (response: any) => {
            if (!response.error) {
      ...
      patchData(){
        this.addEditForm.patchValue({
          ...
          benefit_description: this?.getDetails?.benefit_description || '',
      ...
      add(){
       ...
       //Validation for Business Impact Section..........
        ...
        if (!data?.benefit_description || !data.benefit_description.trim()) {
          this.__shared.toastError('Benefit description is required!');
          return;
        }
        ...
        console.log("params.....",params);
         ...
         ? this.__program3.edit(this.detailsId, params)
         : this.__program3.create(params);
         ...
         apiCall.subscribe(
           response => {
             ...
             if (!response.error) {
                 ...
                 this.__route.navigate(['/exclusive-program/program3-list']);
             } else {
