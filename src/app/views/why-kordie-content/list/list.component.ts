...
export class ListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.kordiePage = this._pageService.getCurrentPage().subscribe((page:any)=>{
      if(page){
        this.current = page
      }
      else{
  ...
  //List Data................
    getList(page = this.current, limit = this.recordsPerPage) {
      ...
      this.__kordie.getList(params, this.searchType, this.searchVal)
          .subscribe((response)=>{
