...
export class ListComponent implements OnInit {
  blogBannerSubs!: Subscription;
  bannerPage!: Subscription;
  totalRecords!: number;
  ...
  constructor(
    private _banner: BlogBannerService,
  ...
  ngOnInit(): void {
    this.bannerPage = this._pageService.getCurrentPage().subscribe((page:any)=>{
      if(page){
        this.current = page
      }
      else{
  ...
  ngOnDestroy(): void {
    if(this.bannerPage){
      this.bannerPage.unsubscribe();
    }
    if(this.blogBannerSubs){
      this.blogBannerSubs.unsubscribe();
    }
  }
  ...
  //List Data................
    getList(page = this.current, limit = this.recordsPerPage) {
      ...
      this.blogBannerSubs = this._banner.getList(params, this.searchType, this.searchVal)
                  .subscribe((response)=>{
