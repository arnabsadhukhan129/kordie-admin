...
export class AddEditGoalComponent implements OnInit {
  ...
  constructor(
    ...
    private _goal: CreateService,
    private _detailsGoal: ViewService,
  ...
  createForm()
    ...
    add(): void {
      ...
      const apiCall = this.detailsId
          ? this._goal.editGoalData(this.detailsId, formData)
          : this._goal.createGoalData(formData);
      ...
      apiCall.subscribe(
          response => {
              ...
              if (!response.error) {
                  ...
                  this.__route.navigate(['/master-list/goal-list']);
              } else {
    ...
    //get details............
    getDetail(){
      this._detailsGoal.getGoalDetailById(this.detailsId)
        .subscribe((response)=>{
