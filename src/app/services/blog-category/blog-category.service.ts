...
export class BlogCategoryService {
  ...
  getList(param: any, searchType:string='', searchVal:string=''): Observable<any> {
    ...
    let url: string = `${this.apiUrl}/category/get-all`;
    if (formData) {
  ...
  delete(id: any): Observable<any> {
    ...
    return this.__http.delete(`${this.apiUrl}/category/delete/${id}`, {
  ...
  create(data: any): Observable<any> {
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.post(`${this.apiUrl}/category/create`, data, {
      headers: {
  ...
  edit(id:any,data:any): Observable<any> {
    ...
    return this.__http.put(`${this.apiUrl}/category/update/${id}`,data,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
  ...
  getDetailById(id:any): Observable<any> {    
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.get(`${this.apiUrl}/category/get-single/${id}`,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
  ...
  changeStatus(id:any,data:any=[]): Observable<any> {
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.put(`${this.apiUrl}/category/${id}/toggle-status`,data,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
}
