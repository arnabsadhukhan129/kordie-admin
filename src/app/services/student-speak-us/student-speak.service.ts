...
export class StudentSpeakService {
  ...
  constructor( private __http: HttpClient) { }
   ...
   getList(param: any, searchType:string='', searchVal:string=''): Observable<any> {
    ...
    let url: string = `${this.apiUrl}/testimonial/get-all`;
    if (formData) {
   ...
   delete(id: any): Observable<any> {
    ...
    return this.__http.delete(`${this.apiUrl}/testimonial/delete/${id}`, {
  ...
  create(data: any): Observable<any> {
    ...
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.post(`${this.apiUrl}/testimonial/create`, data, {
      headers: {
  ...
  edit(id:any,data:any): Observable<any> {
    ...
    return this.__http.put(`${this.apiUrl}/testimonial/update/${id}`,data,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
  ...
  getDetailById(id:any): Observable<any> {    
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.get(`${this.apiUrl}/testimonial/get-single/${id}`,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
}
