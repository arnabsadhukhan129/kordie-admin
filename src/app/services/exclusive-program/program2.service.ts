...
export class Program2Service {
  ...
  //List............
      getList(param: any, searchType:string='', searchVal:string=''): Observable<any> {
        ...
        let url: string = `${this.apiUrl}/hotelconcepts/get-all`;
        if (formData) {
      ...
      delete(key: any): Observable<any> {
        ...
        return this.__http.delete(`${this.apiUrl}/hotelconcepts/delete/${key}`, {
      ...
      create(data: any): Observable<any> {
        ...
        this.portal_login_token = localStorage.getItem('portal_login_token');
        return this.__http.post(`${this.apiUrl}/hotelconcepts/create`, data, {
          headers: {
    ...
    edit(id:any,data:any): Observable<any> {
      this.portal_login_token = localStorage.getItem('portal_login_token');
      return this.__http.put(`${this.apiUrl}/hotelconcepts/update/${id}`,data,{
        headers:{Authorization: 'Bearer '+this.portal_login_token}
      });
    }
    ...
    getDetailById(id:any): Observable<any> {    
      this.portal_login_token = localStorage.getItem('portal_login_token');
      return this.__http.get(`${this.apiUrl}/hotelconcepts/get-single/${id}`,{
        headers:{Authorization: 'Bearer '+this.portal_login_token}
      });
    }
}
