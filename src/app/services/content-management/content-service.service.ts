...
export class ContentServiceService {
  ...
  constructor(
   ...
   getList(param: any, searchType:string='', searchVal:string=''): Observable<any> {
    ...
    let url: string = `${this.apiUrl}/content/get-all`;
    if (formData) {
  ...
  create(data: any): Observable<any> {
    ...
    return this.__http.post(`${this.apiUrl}/content/create-content`, data, {
      headers: {
  ...
  edit(id:any,data:any): Observable<any> {
    ...
    return this.__http.put(`${this.apiUrl}/content/edit-content/${id}`,data,{
  ...
  getDetailById(id:any): Observable<any> {    
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.get(`${this.apiUrl}/content/get-single/${id}`,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
}
