...
export class EnquiryService {
  ...
  getList(param: any, searchType:string='', searchVal:string=''): Observable<any> {
    ...
    let url: string = `${this.apiUrl}/course_enrollment_enquiry`;
    if (formData) {
   ...
   delete(id: any): Observable<any> {
    ...
    return this.__http.delete(`${this.apiUrl}/course_enrollment_enquiry/${id}`, {
  ...
  create(data: any): Observable<any> {
    ...
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.post(`${this.apiUrl}/course_enrollment_enquiry`, data, {
      headers: {
  ...
  edit(id:any,data:any): Observable<any> {
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.put(`${this.apiUrl}/course_enrollment_enquiry`,data,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
  ...
  getDetailById(id:any): Observable<any> {    
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.get(`${this.apiUrl}/course_enrollment_enquiry/${id}`,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }

  //Add Corporate User.........
  createCorporateUser(data: any): Observable<any> {
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.post(`${this.apiUrl}/user/add-corporate`, data, {
      headers: {
        Authorization: 'Bearer ' + this.portal_login_token
      },
    });
