...
export class SubscriptionService {
  ...
  getList(param: any, searchType:string='', searchVal:string=''): Observable<any> {
    ...
    let url: string = `${this.apiUrl}/subscription_plan/get`;
    if (formData) {
   ...
   delete(id: any): Observable<any> {
    ...
    return this.__http.delete(`${this.apiUrl}/subscription_plan/${id}`, {
  ...
  create(data: any): Observable<any> {
    ...
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.post(`${this.apiUrl}/subscription_plan`, data, {
      headers: {
  ...
  edit(id:any,data:any): Observable<any> {
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.put(`${this.apiUrl}/subscription_plan`,data,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
  ...
  getDetailById(id:any): Observable<any> {    
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.get(`${this.apiUrl}/subscription_plan/get/${id}`,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
}
