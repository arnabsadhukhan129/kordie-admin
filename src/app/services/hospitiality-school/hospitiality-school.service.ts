...
export class HospitialitySchoolService {
  ...
  //Hospitality School List.........
  getListWithParam(param: any, searchType:string='', searchVal:string=''): Observable<any> {
    const formData: URLSearchParams = new URLSearchParams();
    const portal_login_token = localStorage.getItem('portal_login_token');
    for (let key in param) {
      formData.set(key, param[key])
    }
    let url: string = `${this.apiUrl}/hospitality/list`;
    if (formData) {
  ...
  delete(id: any): Observable<any> {
    ...
    return this.__http.delete(`${this.apiUrl}/hospitality/${id}`, {
  ...
  createSchool(data: any): Observable<any> {
    ...
    return this.__http.post(`${this.apiUrl}/hospitality/create`, data, {
      headers: {
  ...
  getSchoolDetail(id:any): Observable<any> {    
    this.portal_login_token = localStorage.getItem('portal_login_token');
    return this.__http.get(`${this.apiUrl}/hospitality/${id}`,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }

  //Edit Title.........
  editSchool(id:any,data:any): Observable<any> {

    this.portal_login_token = localStorage.getItem('portal_login_token');

    return this.__http.put(`${this.apiUrl}/hospitality/${id}`,data,{
      headers:{Authorization: 'Bearer '+this.portal_login_token}
    });
  }
}
